          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_0.85fr] gap-10 md:gap-16 items-center">
            <AnimatedSection>
              ...
              <p className="mt-6 text-lg md:text-xl text-charcoal/80 max-w-xl leading-relaxed">
                Weddings, corporate lunches, birthdays, private parties — we roll the trailer up and take care of everything. Tell us the details below and we'll get back to you asap.
              </p>
            </AnimatedSection>
