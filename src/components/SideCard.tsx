  ...
  return (
    <>
      <motion.button
        ...
        className="group bg-bone/80 rounded-sm border border-charcoal/10 overflow-hidden flex items-stretch shadow-sm hover:shadow-md hover:border-ember/40 transition-shadow duration-300 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-ember focus-visible:outline-offset-2 text-left w-full"
      >
        ...
        <div className="p-3 md:p-4 flex-1 flex flex-col justify-center min-w-0">
          <h4 className="font-editorial text-base md:text-lg text-charcoal leading-tight">{side.name}</h4>
          <p className="text-[11px] md:text-xs text-charcoal/65 mt-1 leading-snug">{side.description}</p>
        </div>
      </motion.button>
            ...
            >
              ...
              >
                ...
                <div className="p-6 md:p-8">
                  ...
                  <p className="mt-4 text-base text-charcoal/80 leading-relaxed">{side.description}</p>
                </div>
